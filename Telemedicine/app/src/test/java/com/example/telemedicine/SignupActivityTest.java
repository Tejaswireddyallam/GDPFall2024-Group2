...
public class SignupActivityTest {
    ...
    public void testSuccessfulSignup() {
        ...
        scenario.onActivity(activity -> {
            nameInput.setText("Patienttestid3");
            emailInput.setText("patienttestid3@gmail.com");
            passwordInput.setText("patienttest3");
            confirmPasswordInput.setText("patienttest3");
            roleRadioGroup.check(R.id.radio_patient);
            addressInput.setText("123 Main St");
            contactInput.setText("7995667890");
